<template>
    <div class="container mx-auto px-6 py-10 bg-blue-100 min-h-screen">
      ...
      <!-- Loading State -->
      <p v-if="loading" class="text-gray-600 text-lg">Loading videos...</p>

      <!-- Empty State -->
      <p v-else-if="videos.length === 0" class="text-gray-600 text-lg">
        No videos available.
      </p>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          >
            Watch now <span class="ml-2">▶️</span>
          </a>
        </div>
      </div>
    </div>
...
/* Replaced with bg-blue-100 */
.bg-blue-100 {
  background-color: #ebf8ff; /* Tailwind's bg-blue-100 */
}
