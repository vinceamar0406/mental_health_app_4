...
<template>
    <Head title="Attention Issues Assessment" />
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                            Attention Issues Assessment
                        </h2>
                        <p class="mt-2">Answer the following questions to assess attention issues.</p>

                        <!-- Attention Issues Assessment Form -->
                        <form class="mt-4">
                            <div class="mb-4">
